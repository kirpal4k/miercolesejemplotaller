...
$routes->get('/Animales/listadoPerros', 'Animales::buscarPerro');
$routes->get('/Animales/listadoGatos', 'Animales::buscarGato');
$routes->get('/Animales/listadoAves', 'Animales::buscarAve');
$routes->get('/Animales/listadoCaballos', 'Animales::buscarCaballo');
$routes->get('/Animales/listadoReptiles', 'Animales::buscarReptiles');
